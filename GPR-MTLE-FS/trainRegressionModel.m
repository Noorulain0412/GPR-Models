...
% Auto-generated by MATLAB on 18-Aug-2021 00:54:02
...
predictorNames = {'Rhoohmm', 'Epsilon', 'Velocitymus', 'CurrentkA', 'FrontTimeus', 'Distancem', 'Heightm'};
predictors = inputTable(:, predictorNames);
response = inputTable.LIVskV;
...
trainedModel.RequiredVariables = {'CurrentkA', 'Distancem', 'Epsilon', 'FrontTimeus', 'Heightm', 'Rhoohmm', 'Velocitymus'};
