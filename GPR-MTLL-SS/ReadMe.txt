This model is used to predict the peak values of lightning-induced over-voltages considering various influential parameters such as ground resistivity, ground permittivity, return stroke velocity, return stroke peak current, front time, and distance of lightning channel from overhead line. The peak LIVs will be predicted for the subsequent strokes using the MTLL model and trapezoidal function.
